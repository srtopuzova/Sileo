...
from .views import ArticleListView, CommentListView, FavoriteToggleView, ArticleDetailView, CommentDetailView, CommentLikeToggleView, ArticleRankingView, FavoriteArticleListView
...
urlpatterns = [
    ...
    path('articles/favorites/', FavoriteArticleListView.as_view(), name='favorite-article-list')
]
