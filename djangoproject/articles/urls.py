...
from .views import ArticleListView, CommentListView, FavoriteToggleView, ArticleDetailView, CommentDetailView
...
urlpatterns = [
    ...
    path('articles/<int:article_if>/comments/<int:pk>/', CommentDetailView.as_view(), name = 'comment-detail')
]
